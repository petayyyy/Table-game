...
int pose(uint8_t x, uint8_t y){
  if (y % 2 == 0){
      ...
      id[3] = y*72 + x*3 + 2 + 24; id[4] = y*72 + x*3 + 1 + 24; id[5] = y*72 + x*3 +24;
      id[6] = y*72 + x*3 + 24*2;id[7] = y*72 + x*3 +1 + 24*2;id[8] = y*72 + x*3 +2 + 24*2;
  }
  else{
      id[0] = y*72 + x*3 + 2;id[1] = y*72 + x*3 +1;id[2] = y*72 + x*3;
      id[3] = y*72 + x*3 + 24; id[4] = y*72 + x*3 + 1 + 24; id[5] = y*72 + x*3 +24 + 2;
      id[6] = y*72 + x*3 + 24*2 + 2;id[7] = y*72 + x*3 +1 + 24*2;id[8] = y*72 + x*3 + 24*2;
  }
}
void led_move(){
